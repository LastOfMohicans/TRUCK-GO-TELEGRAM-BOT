...
return [
    ...
    */
    ...
    'ascii' => 'Поле :attribute может содержать только однобайтовые символы ASCII.',
    ...
    'decimal' => 'Поле :attribute должно быть числом с десятичной точкой.',
    ...
    */
    ...
    'custom' => [
        'attribute-name' => [
            'address' => 'Адрес',
            'vendor_material_id' => 'ID материала поставщика',
            'price' => 'Цена',
